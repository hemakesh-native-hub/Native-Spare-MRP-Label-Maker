...
function InnerLabel({ data }) {
  ...
  return (
    <div style={{ width:320, height:320, background:'#FFFFFF', padding:'8px 20px 16px 20px', display:'flex', flexDirection:'column', boxSizing:'border-box', fontFamily:F }}>
      <div style={{ fontSize:14, fontWeight:500, color:'#757575', lineHeight:2, marginBottom:4, fontFamily:F, flexShrink:0 }}>
