...
function LabelRow({ label, value, isLast=false }) {
  return (
    <div>
      <div style={{ display:'flex', alignItems:'flex-start', paddingTop:0, paddingBottom:4 }}>
      ...
      {!isLast && (
        <>
        <div style={{ height:0.5, background:'#FFFFFF', paddingTop:4 }} />
...
function InnerLabel({ data }) {
  ...
  return (
    <div style={{ width:320, height:320, background:'#FFFFFF', padding:'0px 20px 16px 20px', display:'flex', flexDirection:'column', boxSizing:'border-box', fontFamily:F }}>
